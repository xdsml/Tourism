...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 365, ; uint32_t number_of_assemblies_in_apk (0x16d)
...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3341733417732926440, ; hash 0x2e6038d69205ebe8, from name: libgrpc_csharp_ext.x86
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libgrpc_csharp_ext.x86.so
		ptr null; void* handle (0x0)
	}, ; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8372288121842813397, ; hash 0x743057b043a9c9d5, from name: grpc_csharp_ext.x86.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libgrpc_csharp_ext.x86.so
		ptr null; void* handle (0x0)
	}, ; 26
	...
	%struct.DSOCacheEntry {
		i64 9262043430118629323, ; hash 0x8089636d62761fcb, from name: libgrpc_csharp_ext.x86.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libgrpc_csharp_ext.x86.so
		ptr null; void* handle (0x0)
	}, ; 31
	...
	%struct.DSOCacheEntry {
		i64 15666184497637564752, ; hash 0xd96977cc2f6b2150, from name: grpc_csharp_ext.x86
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libgrpc_csharp_ext.x86.so
		ptr null; void* handle (0x0)
	}, ; 39
...
@.env.7 = private unnamed_addr constant [37 x i8] c"1b0a7bb0-ebce-4868-97b1-530bc850d0cd\00", align 1
...
@.DSOCacheEntry.12_name = private unnamed_addr constant [26 x i8] c"libgrpc_csharp_ext.x86.so\00", align 1
